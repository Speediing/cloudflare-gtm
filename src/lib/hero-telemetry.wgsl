...
fn cloudflareMark(p: vec2f) -> f32 {
  let q = rotate(p, -0.06);
  let left = sdEllipse(q - vec2f(-0.10, 0.04), vec2f(0.11, 0.08));
  let mid = sdEllipse(q - vec2f(0.02, -0.02), vec2f(0.14, 0.10));
  let right = sdEllipse(q - vec2f(0.14, 0.03), vec2f(0.10, 0.075));
  let body = opSmoothUnion(opSmoothUnion(left, mid, 0.05), right, 0.045);
  let screen = sdRoundedBox(q - vec2f(0.08, 0.10), vec2f(0.07, 0.05), 0.01);
  let bezel = sdRoundedBox(q - vec2f(0.08, 0.10), vec2f(0.082, 0.062), 0.014);
  var mark = opSmoothUnion(body, bezel, 0.012);
...
fn fs_main(@location(0) uv: vec2f) -> @location(0) vec4f {
  ...
  let dMark = cloudflareMark(markP);
  ...
  let orange = vec3f(0.964706, 0.509804, 0.121569);
